...
<div class="container facilities-container">
    ...
    <div class="facility-card">
        <img src="your-image.png" alt="Facility" class="facility-image">
        <h5 class="mt-3">Clubhouse</h5>
        <p>A building or area used for social or recreational activities, serving as a central gathering place for residents.</p>
