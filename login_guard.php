...
<head>
  ...
  <title>Guard Login | VilMan</title>
  <!-- Bootstrap 5 CSS -->
  ...
  <div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class="row shadow rounded-4 overflow-hidden" style="max-width: 900px; width: 100%;">
      ...
      <div class="col-md-6 bg-white p-4 d-flex flex-column justify-content-center">
        <h3 class="fw-bold text-center mb-4">GUARD</h3>
        ...
        <script>
          document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("loginSuccessModal").addEventListener("hidden.bs.modal", function () {
              window.location.href = "guard_homepage.php";
            });
          });
        </script>
        ...
        <div class="text-center mt-3">
          <small>Don't Have an Account?<br><a href="register_guard.php" class="text-primary fw-bold">Sign Up Here</a></small>
        </div>
      </div>
    </div>
  </div>
