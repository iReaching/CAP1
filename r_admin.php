...
<head>
  ...
  <title>Admin Registration | VilMan</title>
  <!-- Bootstrap 5 CSS -->
...
<body>
  ...
  <div class="container d-flex justify-content-center align-items-center min-vh-100">
    ...
    <div class="col-md-6 bg-white p-4 d-flex flex-column justify-content-center">
      <h3 class="fw-bold text-center mb-4">REGISTER ADMIN ACCOUNT</h3>
      ...
      <div class="text-center mt-3">
        <small>Already have an admin account?<br><a href="l_admin.php" class="text-primary fw-bold">Login Here</a></small>
      </div>
